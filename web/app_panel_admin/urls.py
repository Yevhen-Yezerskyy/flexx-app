...
from .views.clients import (
    ...
    clients_create,
    clients_edit,
    clients_add_contract,
    clients_delete_contract,
...
from .views.user_info import user_info_modal
...
urlpatterns = [
    ...
    path("clients/<int:user_id>/contracts/add/", clients_add_contract, name="panel_admin_clients_add_contract"),
    path("clients/contracts/<int:contract_id>/delete/", clients_delete_contract, name="panel_admin_clients_delete_contract"),
    ...
    path("users/<int:user_id>/info/", user_info_modal, name="panel_admin_user_info"),
